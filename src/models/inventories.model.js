...
module.exports = function (app) {
    ...
    const inventories = new Schema({
        ...
        storeId: { type: Schema.Types.ObjectId, require: [true, 'Invalid store Id'], index: true },
        ...
        productId: { type: Schema.Types.ObjectId, require: [true,'Invalid product Id'], index: true },
        productObject: { type: Schema.Types.Mixed, require: true, index: true },
        totalQuantity: { type: Number, required: [true,'Total quantity (Number) field is required.'] },
        availableQuantity:{ type: Number, required: [true,'Available quntity (Number) field must not be empty.'] },
